...
const types = {
  ...
  'bigint': hasBigInt ? [
    type('min neg (-2147483649n)', bint('-2147483649'), {
      BE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff),
    }),
    type('min pos (4294967296n)', bint('4294967296'), {
      BE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00),
    }),
    type('s_uint64 overflow (9007199254740993n)', bint('9007199254740993'), {
    ...
    type('s_int64 overflow (-9007199254740993n)', bint('-9007199254740993'), {
      BE: byte(0x03, 0x09, 0x06, 0xff, 0xdf, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xdf, 0xff),
    }),
    type('min (-9223372036854775808n)', bint('-9223372036854775808'), {
    ...
    type('max (9223372036854775807n)', bint('9223372036854775807'), {
