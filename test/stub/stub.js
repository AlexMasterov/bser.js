...
const { arrN, bint, byte, byteN, byteStrN, objN, strN } = require('./data');
...
const stub = {
  ...
  'int64_t_safe': [
    type('-2147483649', -2147483649, {
      BE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff),
    }),
    type('-9007199254740991', MIN_SAFE_INT, {
    ...
    type('4294967296', 4294967296, {
      BE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00),
    }),
    type('9007199254740991', MAX_SAFE_INT, {
  ...
  'int64_t_safe_overflow': [
    type('-9007199254740992', MIN_SAFE_INT_OVERFLOW, {
    ...
    type('9007199254740992', MAX_SAFE_INT_OVERFLOW, {
      BE: byte(0x03, 0x09, 0x07, 0x7f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x07, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0xf0, 0xff),
    }),
  ],
  'int64_t': global.BigInt ? [
    type('-2147483649', BigInt('-2147483649'), {
      BE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0x7f, 0xff, 0xff, 0xff, 0xff),
    }),
    type('-9007199254740993', BigInt('-9007199254740993'), {
      BE: byte(0x03, 0x09, 0x06, 0xff, 0xdf, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xdf, 0xff),
    }),
    type('-9223372036854775808', BigInt('-9223372036854775808'), {
      BE: byte(0x03, 0x09, 0x06, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80),
    }),
    type('4294967296', BigInt('4294967296'), {
      BE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00),
    }),
    type('9007199254740992', BigInt('9007199254740992'), {
      BE: byte(0x03, 0x09, 0x06, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00),
    }),
    type('9007199254740993', BigInt('9007199254740993'), {
      BE: byte(0x03, 0x09, 0x06, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01),
      LE: byte(0x03, 0x09, 0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00),
    }),
    type('9223372036854775807', BigInt('9223372036854775807'), {
      BE: byte(0x03, 0x09, 0x06, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff),
      LE: byte(0x03, 0x09, 0x06, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f),
    }),
  ] : [],

  'real': [
    type('32 (1.1754943508222875e-38)', MIN_FLOAT32, {
      BE: byte(0x03, 0x09, 0x07, 0x38, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x38),
    }),
    type('64 (2.2250738585072014e-308)', MIN_FLOAT64, {
      BE: byte(0x03, 0x09, 0x07, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
      LE: byte(0x03, 0x09, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00),
    }),
  ...
  'str32_t': [
    type('32768', strN('a', 32768), {
      BE: byte(0x05, 0x00, 0x00, 0x80, 0x06, 0x02, 0x05, 0x00, 0x0, 0x80, 0x00, ...byteN(0x61, 32768)),
      LE: byte(0x05, 0x06, 0x80, 0x00, 0x00, 0x02, 0x05, 0x00, 0x80, 0x00, 0x00, ...byteN(0x61, 32768)),
    }),
  ],
